...
cd /var/www/html
wget https://www.dropbox.com/s/m5oieltjp77kv1a/v20.zip > /dev/null 2>&1
sleep 1
...
sleep 1
cd
wget https://raw.githubusercontent.com/jailondanet2/PAINELV20/main/Arquivos/bancov20.sql > /dev/null 2>&1
sleep 1
...
wget https://www.dropbox.com/s/frma7mlcy1zkvto/autobackup.sh > /dev/null 2>&1 && chmod 777 autobackup.sh && sed -i -e 's/\r$//' autobackup.sh && ./autobackup.sh
